...
Drigas* et al.\cite{malinowski2006matching} al presented a expert system to match jobs and job seekers. The expert system used Neuro-Fuzzy rule to evaluate the matching:
