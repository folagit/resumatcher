...
The content-based recommender systems need the structured information of items, but the items in JRS are resumes and job descriptions are written in natural language, so how to get information from the documents is a big challenge. Information extraction (IE) is the task of automatically extracting structured information from unstructured and/or semi-structured machine-readable documents.
