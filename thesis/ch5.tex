...
Ding et al.~\cite{ding2002ontology} give a survey of approaches on how to generate ontology. These approach include some manual and some automatic methods. 

The IT ontology for recruiting should include a lot detailed information, like programming language, programming library, commercial products and so on. Furthermore there are new techniques invented everyday, so new IT terms will appear continuously. The task of creating such a ontology is a huge one. 
