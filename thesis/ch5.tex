...
To evaluate this measure, we select 99999 job descriptions, and 99 terms to see the result. We got such relevance matrix by using the algorithm . From the table~\ref{tab:dismatrix}
