...
Based on such observation, we give a new statistical-based Ontology Similarity Measure. Any two concepts $a$ and $b$ in the ontology,   their similarity $S_{a,b}$ could be the ratio of two factors:
