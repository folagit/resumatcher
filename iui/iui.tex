...
\end{table}
 ...
 Based on such observation, we give a new statistical-based Ontology Similarity Measure. Similarity between two concepts can be calculated,  if the two concepts $a$ and $b$ have the same direct hypernym or one  is the hypernym of the other. Their similarity $S_{a,b}$ could be the ratio of two factors:
