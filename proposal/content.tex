...
The system will use rule based information extraction techniques to parse the job description and resume, and get information such as skill, specialties, and background. These information will be used to create the model of job description and job seeker.  Ontology will be used to construct the knowledge base, which will include the taxonomy and rules, to support resume-job matching.
