...
\begin{enumerate}
    \item How to normalize the same concept, but different name or spelling
    \item If one concept in the job description but there is no the same one in the resume, how to calculate the similarity between related concepts.
    \item If one concept in the job description how some similar concepts in the resume, how add summarize total similarity
    \item When calculate the similarity between resume and job description, how to give weight to each concepts.
\end{enumerate}
